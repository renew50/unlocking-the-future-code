...
A>
A><div class="dropup">
A>  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
A>    Dropup
A>    <span class="caret"></span>
A>  </button>
A>  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
A>    <li><a href="#">Action</a></li>
A>    <li><a href="#">Another action</a></li>
A>    <li><a href="#">Something else here</a></li>
A>    <li role="separator" class="divider"></li>
A>    <li><a href="#">Separated link</a></li>
A>  </ul>
A></div>
A>
